  ...
  return (
    <div>
      <div class="grid md:grid-cols-12 sm:grid-cols-1">
        <div class="md:col-span-4 sm:col-span-12 sm:min-h-screen mx-auto ">
          <div class="flex px-5">
          ...
          <div class="max-w-sm px-5 rounded overflow-hidden">
            <img
              class="w-full"
        ...
        <div class="md:col-span-7 sm:col-span-12 overflow-scroll no-scrollbar">
          <div class="p-5">
