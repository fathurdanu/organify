      ...
      <div className="grid md:grid-cols-12 sm:grid-cols-1">
        <div className="md:col-span-4 sm:col-span-12 sm:min-h-screen mx-auto ">
          <div className="flex px-5">
            <h1 className="text-lg font-semibold pt-10 pb-5">Product Details</h1>
            ...
            <div className="pt-10 pl-4">
              <button
                className="bg-red-600 text-black rounded px-2 py-1 hover:bg-black hover:text-red-600"
                onClick={() => navigate("/cms/edit")}
              >
                <div className="flex">
                  <BsFillTrashFill className="mt-1 mr-1" />
                  <h1 className="text-sm font-semibold">Delete</h1>
                </div>
              </button>
            </div>
          </div>
