...
const CheckoutPage = () => {
  ...
  return (
    ...
    (action === "GET_ORDER_BY_USER_ID" && status === "data" && data !== "loading") ?
                  ...
                  return (
                    <tr key={index}>
                      <td className="hidden pb-4 md:table-cell">
                        <a href="#">
                          <img
                            src={base_url + '/images/' + product.ProductImages[0].filename}
                      ...
                      <td className="hidden text-right md:table-cell pb-3">
                        <span className="text-sm lg:text-base font-medium">{product.LineItem.qty}</span>
                      </td>
                      <td className="hidden text-right md:table-cell pb-3">
                        <span className="text-sm lg:text-base font-medium">{product.price}</span>
                      </td>
